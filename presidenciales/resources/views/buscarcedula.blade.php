...
Busca la Cedula @if(Auth::user()->estados == 'TODOS') en todos los estados @else del Estado {{ Auth::user()->estados }} @endif
@endsection
		...
		<div class="panel-body">
			<div class="box box-danger">
				<div class="box-header with-border">
					<center>
						<h3 class="box-title">BUSQUEDA DEL PERSONAL @if(Auth::user()->estados == 'TODOS') DE TODAS LAS DIRECCIONES @else del Estado {{ Auth::user()->estados }} @endif</h3>
					</center>
				</div>
				<div class="box-body">
						...
						<div>
							...
							<div class="col-lg-4">
								<center>
									...
									<label>Cédula</label>
									<input type="text" class="form-control" placeholder="Cedula del Empleado" name="cedula" id="cedula">
								</center>
							</div>
							<div class="col-lg-4"></div>
						</div>
					...
					<center>
						<div class="box-footer">
							<button type="button" class="btn btn-danger" onclick="accionModal('cedulaempleado',$('#cedula').val());" >Buscar</button>
						</div>
					</center>
