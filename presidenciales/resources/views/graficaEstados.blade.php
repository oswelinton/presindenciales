...
<script type="text/javascript">
	...
	{
		$.get('/graficaEstadosJSON/{{ $estado }}', function(data) {
			...
			var options={
				...
				title: {
					text: '<b>RESULTADOS  {{ $estado }} DE LAS ELECCIONES MUNICIPALES 2025</b>'
				},
				subtitle: {
					text: ''
				},
...
function dibujagrafico2(dibujar)
	{
		$.get('/graficaEstadosJSON2/{{ $estado }}', function(data) {
			// alert(JSON.stringify(data));
			console.clear;
			// console.table(data);
			...
			var options={
				...
				title: {
					text: '<b>RESULTADOS POR GENERO (MASCULINO / FEMENINO)</b>'
				},
				subtitle: {
					text: ''
				},
...
function dibujagrafico3(dibujar){
		...
		$.get('/graficaEstadosJSON3/{{ $estado }}', function(data) {
...
<!-- <div class="container-fluid">
	<div class="col-lg-12 col-sm-12 col-sm-offset-0">
		<div class="panel-body">
			...
			<div id="viewGrafico2" style="min-width: 310px; height: 400px; margin: 0 auto">
			</div>
